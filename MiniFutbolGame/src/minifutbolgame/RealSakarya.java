 ...
 * @author Oguzhan
 */
public class RealSakarya extends Takim{
    private String ozelYetenek;

    public RealSakarya(String takim_adi, String teknik_direktor, int atak_gucu, int defans, String ozelYetenek) {
    ...
    public void takimBilgisiGoster(){
        ...
        System.out.println("Teknik Direktor :" + getTeknik_direktor() );
